              ...
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="right">Users Registered</TableCell>
                  ...
                  {lists.map((list) => (
                    <TableRow>
                      ...
                      <TableCell align="right">
                        {format(new Date(list.allow_booking_date), "yyyy-MM-dd")}
                      </TableCell>
                      <TableCell align="right">{list.Total_bookings}</TableCell>
                      <TableCell align="right">
